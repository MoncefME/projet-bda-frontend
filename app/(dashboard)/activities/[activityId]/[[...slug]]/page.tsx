...
const ActivityPage = ({
  ...
  params: { activityId: number; slug: string[] };
}) => {
  ...
  const fetchActivityData = async () => {
    ...
    const speedDistanceResponse = await getSpeedVSDistance(
      params.activityId,
  ...
  return (
    <div className="flex w-full flex-1 flex-col gap-4 bg-blue-100 p-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-1 flex flex-col items-center justify-center gap-8 rounded-lg bg-white p-4 shadow-md">
